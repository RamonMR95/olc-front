  ...
  var e = window.document,
    ...
    k = function(e, t, o) {
      ...
      var i,
        ...
        s = e.appendChild(
          r(
            ...
            {
              className:
                "widget" + (/^large$/i.test(t["data-size"]) ? " widget-lg" : "")
            },
            [d]
          )
        ),
      ...
      var h = f.length,
        g = (" /" + d.pathname).split(/\/+/);
      if (
        ((((2 === h || (3 === h && "gist" === f[2])) && "archive" === g[3]) ||
          (2 === h && "releases" === g[3] && "download" === g[4]) ||
          (3 === h && "codeload" === f[2])) &&
          (d.target = "_top"),
        /^true$/i.test(t["data-show-count"]) && 2 === h)
      ) {
        var p, x;
